...
import kotlinx.android.synthetic.main.activity_result.user
import kotlinx.android.synthetic.main.activity_result.pass
    ...
    private fun Result(){
        ...
        call.enqueue(object : retrofit2.Callback<Default>{
            ...
            override fun onResponse(call: Call<Default>?, response: Response<Default>?) {
                ...
                user.setText(response?.body()?.username)
                pass.setText(response?.body()?.Password)




                if (response?.body()?.username.isNullOrBlank()){
                    user.setText("bukan karyawan")
                    pass.setText("null")
